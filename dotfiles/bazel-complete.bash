...
BAZEL_COMMAND_LIST="analyze-profile build canonicalize-flags clean coverage cquery dump fetch help info license mobile-install print_action query run shutdown test version"
BAZEL_INFO_KEYS="
workspace
install_base
output_base
...
--incompatible_show_all_print_messages
--noincompatible_show_all_print_messages
...
--memory_profile_stable_heap_parameters=
--message_translations=
--mode={classic,classic_internal_test_do_not_use,skylark,skylark_incremental_res}
--objc_debug_with_GLIBCXX
--noobjc_debug_with_GLIBCXX
--objc_enable_binary_stripping
--noobjc_enable_binary_stripping
